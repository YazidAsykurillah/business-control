    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'  => 'quotation-customer',
                ],
                [
                    'text' => 'Quotation Vendor',
                    'url'  => '#',
                ],
            ],
        ],
        ...
        [
            ...
            'active' => ['customer', 'customer/*', 'regex:@^customer/[0-9]+$@']
        ],
        [
            'text' => 'Vendors',
            'url'  => 'vendor',
        ...
        'Autonumeric' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/autonumeric/autoNumeric.js',
                ],
            ],
        ],
        'Accounting' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/accounting/accounting.js',
                ],
            ],
        ],
        'Moment' => [
